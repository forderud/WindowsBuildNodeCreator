...
# Download Wix 3 Visual Studio extension
...
# Install Wix 3 Visual Studio extension
...
# Download Wix5 HeatWave Visual Studio extension for VS2022
...
# Install Wix5 HeatWave Visual Studio extension for VS2022
$process = Start-Process -FilePath $installerPath -ArgumentList @('/quiet', "`"$filePath`"") -Wait -PassThru
if ($process.ExitCode -ne 0) {
